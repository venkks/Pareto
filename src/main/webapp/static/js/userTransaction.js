/**
 * Created by NARAYANA on 11/18/2015.
 */
/**
...
function renderHTML(data) {
    ...
    var renderTable="";
    renderTable="<table id='datatable-table' class='table table-striped table-hover'><thead><tr><th>Member Name</th><th>Date</th><th>₹ Rs.</th><th>Payment Mode</th><th>Transaction Type</th><th>Reported By</th></tr></thead><tbody>"
    ...
    for(var i=0;i<result.length;i++)
    {
        ...
        renderTable+="<tr><td>" + result[i].fullName + "</td><td>" + result[i].transaction_date +"</td><td style='color: "+ amountClr +"'> " + amount+ "</td><td>" + result[i].paymentMode+"</td><td>" + result[i].payment_type +"</td><td>" + result[i].createdByUser +"</td></tr>";
    }
    document.getElementById("tableData").innerHTML=renderTable;
