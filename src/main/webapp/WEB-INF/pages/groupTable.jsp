            ...
            <section class="widget">
                ...
                <div class="btn-toolbar">
                    ...
                    <a href="<%=request.getContextPath()%>/AddGroup"
                       class="btn btn-warning width-100 mb-xs btn btn-sm btn-default pull-right " role="button">ADD
                        GROUP</a>
                </div>
                    ...
                    <div class="mt">
                        <table id="datatable-table" class="table table-striped table-hover">
                            ...
                            <c:forEach items="${groupList}" var="group">
                                <tr>
                                    <td>
                                    <a href="<%=request.getContextPath()%>/GroupDetail?GroupId=${group.groupId}">${group.groupName} (${group.noOfMembers})</a>                                  </td>
